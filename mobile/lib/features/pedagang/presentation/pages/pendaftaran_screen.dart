...
/// TAB ROOT (menu "Pendaftaran" pedagang) -- build() return body
/// langsung. Pindah ke tab "Status Verifikasi" sekarang lewat
...
class _PendaftaranScreenState extends ConsumerState<PendaftaranScreen> {
  ...
  void initState() {
    ...
    // sebelumnya"), langsung arahin ke tab Status Verifikasi.
  ...
  void _gotoStatusVerifikasiTab() {
    final menus = ref.read(menuListProvider).value ?? [];
    final idx = menus.indexWhere((m) => m.path == '/pedagang/status-verifikasi');
    if (idx != -1) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: _gotoStatusVerifikasiTab,

...
type PengaturanPendaftaran struct {
	...
	// KodeEvent jadi prefix nomor lapak acak (lihat modules/pedagang/lapak) --
	// "CFD" buat Car Free Day, nanti bisa diganti petugas per event lain
	// (mis. "MRT" buat Marathon) dari halaman Jam Operasional yang sama.
	KodeEvent string    `db:"kode_event"`
